...
/**
 * √лавный класс приложени€, отвечающий за инициализацию и запуск программы.
 * ¬ этом классе создаютс€ основные компоненты, регистрируютс€ команды и начинаетс€ работа консольного приложени€.
 */
public class Main {

    /**
     * «десь выполн€етс€ настройка и запуск приложени€.
     */
